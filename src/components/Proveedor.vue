...
<v-layout align-start>
    <v-flex>
        <v-data-table :headers="headers" :items="personas" :search="search" sort-by="nombre" class="elevation-1">
...
export default {
    data() {
        return {
            ...
            tipo_documento: '',
            documentos: ['DNI', 'RUC', 'PASAPORTE', 'CI'],
            num_documento: '',
            direccion: '',
            telefono: '',
            email: '',
    ...
    methods: {
        ...
        validar() {
            ...
            if (this.num_documento.length > 20) {
                this.validaMensaje.push('El documento no debe tener mas de 20 caracteres.');
            }
            if (this.direccion.length > 70) {
                this.validaMensaje.push('La dirección no debe tener mas de 70 caracteres.');
            }
            if (this.telefono.length > 20) {
                this.validaMensaje.push('El teléfono no debe tener mas de 20 caracteres.');
            }
            if (this.email.length > 50) {
                this.validaMensaje.push('El email de la persona debe tener menos de 50 caracteres.');
            }
