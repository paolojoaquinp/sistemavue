...
<v-layout align-start>
    <v-flex>
        <v-data-table :headers="headers" :items="articulos" :search="search" sort-by="nombre" class="elevation-1">
                            ...
                            <v-card-text>
                                <v-container>
                                    <v-row>
                                        ...
                                        <v-col cols="12" sm="6" md="6">
                                            <v-select v-model="categoria" :items="categorias" label="Categoria"></v-select>
                                        </v-col>
    ...
    methods: {
        ...
        validar() {
            ...
            if (this.codigo.length > 64) {
                this.validaMensaje.push('El código no debe tener mas de 64 caracteres');
            }
            ...
            if (this.descripcion.length > 255) {
                this.validaMensaje.push('La descripcion del articulo no debe tener mas de 255 caracteres.');
            }
            if (this.stock < 0) {
